...
import ProfitSummary from '@/components/views/AISignalAnalysis/AssetsManagement/ProfitSummary'
import DayHold from '@/components/views/AISignalAnalysis/AssetsManagement/DayHold'
var mockSignals = [
{
