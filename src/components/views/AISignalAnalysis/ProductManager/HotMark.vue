<template>
	<div id="hot-mark-analysis">

	 <div class="hot-mark-top">
	 	 <div class="hot-mark-top-paddding">
	 ...
	 <div class="hot-mark-bottom">
	 	<div class="hot-mark-bottom-padding">
